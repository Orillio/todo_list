          ...
          child: Consumer<VisibilityChangeNotifier>(
            builder: (context, visibilityProvider, _) {
              return ListView.builder(
                ...
                shrinkWrap: true,
                itemCount: todoProvider.tasks.length + 1,
                itemBuilder: (context, index) {
                  if (index == todoProvider.tasks.length) {
                    return Focus(
                  ...
                  if (!todoProvider.tasks[index].done ||
                      visibilityProvider.isVisible) {
                    return TodoListItem(
                      model: todoProvider.tasks[index],
                    );
                  }
